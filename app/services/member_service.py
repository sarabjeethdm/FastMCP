...
def get_member_by_name(name: str, health_plan_id: str = None, year_of_service: int = None):
    """
...
def get_member_eligibility_by_name(name: str, year: str, health_plan_id: str = None, year_of_service: int = None):
...
def get_member_claims_by_name(name: str, health_plan_id: str = None, year_of_service: int = None):
    member = get_member_by_name(name, health_plan_id, year_of_service)
    if not member:
        return "Member not found"
...
def get_member_hccs_by_name(name: str, health_plan_id: str = None, year_of_service: int = None):
    member = get_member_by_name(name, health_plan_id, year_of_service)
    if not member:
        return "Member not found"
...
def get_members_by_eligibility_year(year: str, health_plan_id: str = None, year_of_service: int = None):
...
def get_all_members(limit: int = 50, health_plan_id: str = None, year_of_service: int = None):
    query = {}
    if health_plan_id:
        query["healthPlanId"] = health_plan_id
    if year_of_service:
    ...
    members = collection.find(
        query,
        {"Name": 1, "DOB": 1, "MBI": 1, "deltaRiskScore": 1, "yearOfService": 1, "healthPlanId": 1}
    ).limit(limit)
